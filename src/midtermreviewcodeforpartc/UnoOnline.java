...
public class UnoOnline 
{
    ...
    private void run() {
        ...
        PasswordValidator passwordToBeValidated = new PasswordValidator(password);
        
        passwordToBeValidated.passwordValidate(password);
        
        
//        if ( passwordToBeValidated.passwordValidate(password) == true ) {
